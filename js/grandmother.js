function createToDoList() {
  ...
  divContainerZadanieFirst.textContent = "ToDoSpisok-4";
  ...
  h4_mb_5.textContent = "Задания бабушки";
...
if (localStorage.getItem("tasksGrMother")) {
  tasks = JSON.parse(localStorage.getItem("tasksGrMother")); //если есть что-то парсим в масив
}
...
function saveToLocalStorage() {
  ...
  localStorage.setItem("tasksGrMother", JSON.stringify(tasks)); // "tasks это наш ключ" 2 -аргумент - и мы хотим записать массив или объект его необходимо трансформировать в JSON.stringify(tasks)
