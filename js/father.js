function createToDoList() {
  ...
  divContainerZadanieFirst.textContent = "ToDoSpisok-3";
  ...
  h4_mb_5.textContent = "Задания папы";
...
if (localStorage.getItem("tasksFather")) {
  tasks = JSON.parse(localStorage.getItem("tasksFather")); //если есть что-то парсим в масив
}
...
function saveToLocalStorage() {
  ...
  localStorage.setItem("tasksFather", JSON.stringify(tasks)); // "tasks это наш ключ" 2 -аргумент - и мы хотим записать массив или объект его необходимо трансформировать в JSON.stringify(tasks)
